						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<label class="radio-inline">
									<input name="args[cstype]" type="radio" value="0" <?php if(!$this->tpl_var['course']['cstype']){ ?>checked<?php } ?>/>开放模式
								</label>
								<label class="radio-inline">
									<input name="args[cstype]" type="radio" value="1" <?php if($this->tpl_var['course']['cstype']){ ?>checked<?php } ?>/>解锁模式
								</label>
							</div>
						</div>
				        <div class="form-group">
