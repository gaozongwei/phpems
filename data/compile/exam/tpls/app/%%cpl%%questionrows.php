			...
			<div class="col-xs-2" style="padding-top:10px;margin-bottom:0px;">
				<div class="panel panel-primary">
					<div id="panel-element-212076" class="panel-collapse<?php if($this->tpl_var['method'] == 'questions' || $this->tpl_var['method'] == 'rowsquestions' || $this->tpl_var['method'] == 'feedback'){ ?> in<?php } ?> collapse" role="tabpanel">
			     		<ul class="list-group">
							<li class="list-group-item"><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-app-questions">普通试题管理</a></li>
							<li class="list-group-item active"><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-app-questions-questionrows">题帽题管理</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<?php } ?>
 ...
 $qid++; ?>
					        <tr>
								...
								<td>
									<a title="查看试题" class="selfmodal" href="javascript:;" url="index.php?exam-app-questions-rowsdetail&questionid=<?php echo $question['qrid']; ?>&<?php echo TIME; ?>" data-target="#modal"><?php echo $this->G->make('strings')->subString(strip_tags(html_entity_decode($question['qrquestion'])),135); ?></a>
								</td>
								<td>
