...
<?php } ?>
		<div class="pagecontent" id="exam-paper-swiper">
 ...
 $sid++; ?>
							...
							<?php } ?>
							<div class="toolbar" style="padding:1rem 0.5rem;margin-bottom:4rem;">
								<?php if($qcid > 1){ ?>
 ...
 $sid++; ?>
			...
			<div class="container-fluid text-center" style="background-color:#337AB7;z-index:9999;position:fixed;bottom:0px;border-top:1px solid #E9E9E9;">
				<div style="clear:both;background-color:#337AB7;padding-top:0px;border:0px;padding:0rem;padding-bottom:0.8rem;" class="input-group-addon footer">
					...
					<div class="col-xs-3">
						<div class="text-center" style="height:4.2rem;padding:0.2rem;">
							<a href="#submodal" onclick="javascript:$('#submodal').appendTo('body');" role="button" data-toggle="modal">
			...
			$(document).ready(function(){
				$('#exam-paper-swiper').on('swiperight',function(){
                    if(qindex >= 1){
                        gotoindexquestion(--qindex);
                    }
                });
                $('#exam-paper-swiper').on('swipeleft',function(){
                    if(qindex < ($('#exam-paper-swiper .paperexamcontent').length-1)){
                        gotoindexquestion(++qindex);
                    }
                });
